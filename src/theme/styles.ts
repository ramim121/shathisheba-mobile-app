...
export const styles = StyleSheet.create({
  ...
  menuFormScroll: { paddingTop: 4, paddingBottom: 28 },
  ...
  kycChipRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginHorizontal: 16, marginTop: 6 },
  // A content-sized pill for wrapping choice rows (genderPill stretches to fill).
  choiceChip: { minHeight: 42, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 10, borderWidth: 1, borderColor: colors.line, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.card },
  ...
  tileIcon: { fontSize: 31, lineHeight: 38, marginBottom: 8, textAlign: 'left' },
  ...
  adviceGrid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 10, columnGap: 10, paddingHorizontal: 16 },
